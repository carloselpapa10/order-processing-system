...
import org.ordersample.invoiceservice.impl.InvoiceServiceImpl;
...
@SpringBootTest(classes = InvoiceServiceInMemoryIntegrationTest.TestConfiguration.class,
        webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
public class InvoiceServiceInMemoryIntegrationTest {
    ...
    @Import({InvoiceServiceCommandHandlersConfiguration.class,
    ...
    public static class TestConfiguration {
        ...
        @Bean
        public InvoiceService invoiceService(InvoiceRepository invoiceRepository, Optional<MeterRegistry> meterRegistry){
            return new InvoiceServiceImpl(invoiceRepository, meterRegistry);
        }
    }
    ...
    @Test
    public void shouldRequestInvoice(){

        Invoice invoice = new Invoice("111", "Invoice Comment");
        ...
        String messageId = commandProducer.send("invoiceservice", null, new RequestInvoiceCommand(new InvoiceDTO("", "111", "Invoice Comment")),
