...
public class OrderCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2029727481731703143L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderCreatedEvent\",\"namespace\":\"io.example.ordersample.avro.schemas\",\"fields\":[{\"name\":\"id\",\"type\":\"string\",\"doc\":\"Id of Order\"},{\"name\":\"description\",\"type\":\"string\",\"doc\":\"Description of Order\"},{\"name\":\"customerId\",\"type\":\"string\",\"doc\":\"Id of customer\"}],\"version\":\"1\"}");
   ...
   */
  public OrderCreatedEvent(java.lang.CharSequence id, java.lang.CharSequence description, java.lang.CharSequence customerId) {
    this.id = id;
